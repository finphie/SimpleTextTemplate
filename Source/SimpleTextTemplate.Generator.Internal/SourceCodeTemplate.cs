...
namespace SimpleTextTemplate.Generator
{
    ...
    public partial class SourceCodeTemplate : SourceCodeTemplateBase
    {
        /// <summary>
        ...
        public virtual string TransformText()
        {
            ...
            this.Write("\r\n\r\npartial ");
            this.Write(this.ToStringHelper.ToStringWithCulture(ClassOrStructText));
            this.Write(" ");
            ...
            this.Write("\", \"");
            this.Write(this.ToStringHelper.ToStringWithCulture(GeneratorVersion));
            this.Write("\")]\r\n    ");
            this.Write(this.ToStringHelper.ToStringWithCulture(MethodAccessibilityText));
            this.Write(" static partial void ");
            this.Write(this.ToStringHelper.ToStringWithCulture(MethodName));
            this.Write("(global::System.Buffers.IBufferWriter<byte> ");
            this.Write(this.ToStringHelper.ToStringWithCulture(BufferWriterParameterName));
            this.Write(", ");
 ...
 if (type == BlockType.Raw) { 
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "17.0.0.0")]
    public class SourceCodeTemplateBase
    {
        #region Fields
