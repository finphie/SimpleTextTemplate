...
readonly ref struct Emitter(SourceProductionContext context, ImmutableArray<InterceptInfo> infoList) : IDisposable
{
    ...
    public void Emit()
    {
        ...
        _writer.WriteLine("// <auto-generated/>"u8);
        _writer.WriteLine("#pragma warning disable"u8);
        _writer.WriteLine();
        _writer.WriteLine("namespace SimpleTextTemplate.Generator"u8);

        using (_writer.WriteBlock())
        {
            _writer.WriteLine($"""[global::System.CodeDom.Compiler.GeneratedCode("{FullName}", "{Version}")]""");
            _writer.WriteLine("file static class Intercept"u8);
        ...
        _writer.WriteLine();
        _writer.WriteLine("namespace System.Runtime.CompilerServices"u8);

        using (_writer.WriteBlock())
        {
            _writer.WriteLine($"""[global::System.CodeDom.Compiler.GeneratedCode("{FullName}", "{Version}")]""");
            _writer.WriteLine("[global::System.AttributeUsage(global::System.AttributeTargets.Method, AllowMultiple = true)]"u8);
            _writer.WriteLine("file sealed class InterceptsLocationAttribute(int version, string data) : global::System.Attribute;"u8);
        }

        var buffer = _writer.WrittenSpan.ToArray();
        var a = Encoding.UTF8.GetString(buffer);
        _context.AddSource("SimpleTextTemplate.Generated.cs", SourceText.From(a, Encoding.UTF8));
    }
    ...
    void WriteCultures()
    {
        ...
        _writer.WriteLine();
        _writer.WriteLine("[global::System.Runtime.CompilerServices.ModuleInitializer]"u8);
        _writer.WriteLine("public static void Initialize()"u8);
